...
result[,4:13] <- result[,4:13] / (1+log(result[,3]))
result[,14] <- str_replace_all(result[,14],"nan,", "")
result[,14] <- substr(result[,14],2,1000)
result[,14] <- str_replace_all(result[,14],",nan", "")
result[,14] <- str_replace_all(result[,14],"nan", "")
result[,14] <- trimws(result[,14])

result[,15] <- str_replace_all(result[,15],"nan,", "")
result[,15] <- substr(result[,15],2,1000)
result[,15] <- str_replace_all(result[,15],",nan", "")
result[,15] <- str_replace_all(result[,15],"nan", "")
result[,15] <- trimws(result[,15])
#result[,14:15] <- substr(result[,14],2,1000)
#result[,14:15] <- substr(result[,15],2,1000) 
